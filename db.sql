...
DROP TABLE IF EXISTS jxshop_display_history;
CREATE TABLE jxshop_display_history
(
	id mediumint unsigned not null auto_increment comment 'Id',
	member_id mediumint unsigned not null comment '会员id',
	goods_id mediumint unsigned not null comment '商品id',
	view_time int unsigned not null comment '浏览时间',
	primary key (id),
	key goods_id(goods_id),
	key member_id(member_id)
)engine=MyISAM default charset=utf8 comment '浏览历史';

DROP TABLE IF EXISTS jxshop_cart;
CREATE TABLE jxshop_cart
(
	id mediumint unsigned not null auto_increment comment 'Id',
	member_id mediumint unsigned not null comment '会员id',
	goods_id mediumint unsigned not null comment '商品id',
...
DROP TABLE IF EXISTS jxshop_order;
CREATE TABLE jxshop_order
(
	id mediumint unsigned not null auto_increment comment 'Id',
	member_id mediumint unsigned not null comment '会员id',
...
DROP TABLE IF EXISTS jxshop_order_goods;
CREATE TABLE jxshop_order_goods
(
...
DROP TABLE IF EXISTS jxshop_comment;
CREATE TABLE jxshop_comment
(
	id mediumint unsigned not null auto_increment comment 'Id',
	member_id mediumint unsigned not null comment '会员id',
	goods_id mediumint unsigned not null comment '商品id',
	...
	star tinyint unsigned not null comment '评论的分值',
	good_number mediumint unsigned not null default '0' comment '有用的数字',
	primary key (id),
	key goods_id(goods_id)
)engine=MyISAM default charset=utf8 comment '评论';

DROP TABLE IF EXISTS jxshop_comment_reply;
CREATE TABLE jxshop_comment_reply
(
	id mediumint unsigned not null auto_increment comment 'Id',
	member_id mediumint unsigned not null comment '会员id',
...
)engine=MyISAM default charset=utf8 comment '评论回复';

DROP TABLE IF EXISTS jxshop_impression;
CREATE TABLE jxshop_impression
(
	id mediumint unsigned not null auto_increment comment 'Id',
	goods_id mediumint unsigned not null comment '商品id',
	yx_name varchar(30) not null comment '印象名称',
	yx_count mediumint unsigned not null default '0' comment '印象出现的次数',
	primary key (id),
	key goods_id(goods_id)
